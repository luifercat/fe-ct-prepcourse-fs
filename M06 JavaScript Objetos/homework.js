...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
   objeto[propiedad] = null;  //no funciona con dot notation--> objeto.propiedad = null,
   return objeto;
}
//
...
function eliminarPropiedad(objeto, propiedad) {
   ...
   //delete objeto.propiedad;   asi no funciona debe ser bracket notation
   return (objeto);
}
...
function verificarPassword(objetoUsuario, password) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   //if (objetoUsuario.password == [password]) {   // tambien sirve de esta forma
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () {
      var precioFinal = 0;
      //  cualquiera de las dos siguiente formas se puede
